        ...
        success:function(data){
            if(isEmptyObject(data.List)&&pageNum>0){
                ...
                for(i in list){
                    ...
                    htmlStr="<tr data-listid=\""+list[i].listid+"\"><td>"+list[i].householdname+"</td><td>"+list[i].holdphone+"</td><td>"+sdate+"</td><td>"+edate+"</td><td>"+list[i].money+"</td><td>"+btnStr+"</td></tr>";
    ...
    $.ajax({
        ...
        success:function(data){
            if(data.code==0){
                ...
                $("#userTable").empty();
                htmlStr="<tr><th>工号</th><td>"+user.IDnumber+"</td></tr><tr><th>姓名</th><td>"+user.username+"</td></tr><tr><th>电话</th><td>"+phone+"</td></tr>"
